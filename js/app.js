  ...
  getSampleProducts() {
    return [
      ...
      },
      {
        ...
        ingredients: [" زبدة طبيعية 100% ", "ملح بحري"],
        is_organic: false,
        category: "dairy",
      ...
      },
      {
        ...
        long_desc:
          "عسل الليمون عسل طبيعي بنكهة خفيفة ومنعشة، كيجمع بين حلاوة العسل وحموضة الليمون الرقيقة، وكيعاون على تقوية المناعة وتهدئة الحلق، كما يمنح طاقة طبيعية للجسم.",
        ingredients: ["100% عسل خام"],
        is_organic: true,
        category: "oil",
        image: "assets/images/asal-laymon.png",
      },
      {
        id: 5,
        name: "عسل الخروب",
        ...
        long_desc:
          "عسل ذو لون غامق ونكهة قوية ومميزة جاية من شجر الخروب، كيتميز بفوائده في تنظيم الهضم وتزويد الجسم بالمعادن ومنح طاقة طبيعية وصحية.",
        ingredients: ["100% عسل خام"],
        is_organic: true,
        category: "pantry",
        image: "assets/images/asal-kharob.png",
      },
      {
        id: 6,
        name: "عسل اعشاب",
        ...
        long_desc:
          "عسل طبيعي مستخلص من مجموعة نباتات برّيّة وأعشاب طيبة الرائحة، كيتميز بنكهات متعددة وغنية، وكيعاون في تهدئة الأعصاب وتحسين الهضم وتقوية المناعة بشكل طبيعي.",
        ingredients: ["100% عسل خام"],
        is_organic: true,
        category: "pantry",
        image: "assets/images/asal-achab.png",
      },
      {
        id: 7,
        name: "زيتون مرقد",
        ...
        long_desc:
          "الزيتون المراقد فالماء كيتحضّر بطريقة طبيعية باش يحتافظ بنكهتو الأصلية بلا مواد إضافية.",
        ingredients: ["100% زيتون"],
        is_organic: true,
        category: "pantry",
