  ...
  getSampleProducts() {
    return [
      ...
      },
      {
        ...
        long_desc:
          "عسل الليمون عسل طبيعي بنكهة خفيفة ومنعشة، كيجمع بين حلاوة العسل وحموضة الليمون الرقيقة.
كيعاون على تقوية المناعة، وكيهدي الحلق، وكيعطي طاقة طبيعية للجسم.",
      ...
      },
      {
        ...
        long_desc:
          "عسل ذو لون غامق ونكهة قوية ومميزة جايّة من شجر الخروب.
كيعرف بفوائده فتنظيم الهضم، تزويد الجسم بالمعادن، ومنح طاقة طبيعية وصحية.",
        ingredients: ["100% عسل خام"],
        is_organic: true,
        category: "pantry",
      ...
      },
      {
        ...
        long_desc:
          "عسل طبيعي مستخلص من مجموعة نباتات برّيّة وأعشاب طيبة الرائحة، كيتميز بنكهات متعددة وغنية.
كيعاون فتهدئة الأعصاب، تحسين الهضم، وتقوية المناعة بشكل طبيعي.",
        ingredients: ["100% عسل خام"],
        is_organic: true,
        category: "pantry",
